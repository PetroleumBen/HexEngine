...
namespace HexMapEngine
{
    ...
    public static class HexDirectionExtension 
    {
        ...
        private static readonly Vector3 Vector3Forward = new Vector3(0, 0, 1);
        ...
        private static readonly float[] _angles = new[] {0f, 60f, 120f, 180f, 240f, 300f};

        private static readonly Vector3[] _directions = new[] {
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[0], 0f)),
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[1], 0f)),
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[2], 0f)),
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[3], 0f)),
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[4], 0f)),
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[5], 0f))
        };

        private static readonly Vector3[] _vertexDirections = new[] {
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[0] - 30f, 0f)),
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[1] - 30f, 0f)),
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[2] - 30f, 0f)),
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[3] - 30f, 0f)),
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[4] - 30f, 0f)),
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[5] - 30f, 0f))
        };

        private const float VertexFactor = .5f * HexMath.InToOutRadius;
        private static readonly Vector3[] _vertices = new[] {
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[0] - 30f, 0f)) * VertexFactor,
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[1] - 30f, 0f)) * VertexFactor,
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[2] - 30f, 0f)) * VertexFactor,
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[3] - 30f, 0f)) * VertexFactor,
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[4] - 30f, 0f)) * VertexFactor,
            HexMath.LeftChainTransform(Vector3Forward, HexMath.ToQuaternion(0f, _angles[5] - 30f, 0f)) * VertexFactor
        };
        #endregion
        ...
        /// <summary>
        /// Normalized vector of direction in 3D space for HexDirection, where HexDirection.N is new Vector3(0, 0, 1).
        /// </summary>
